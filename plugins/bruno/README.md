...
dead-end the dialog with a paragraph about what to edit by hand. It still says
that, as the reason the pull-request radio is disabled, rather than as the end
of the flow.
